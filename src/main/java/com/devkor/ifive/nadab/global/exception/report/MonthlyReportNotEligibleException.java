...
@Getter
public class MonthlyReportNotEligibleException extends BadRequestException {
    private final CompletedCountResponse completedCountResponse;

    public MonthlyReportNotEligibleException(ErrorCode errorCode, CompletedCountResponse completedCount) {
        super(errorCode);
