...
@Profile("local")
@Slf4j
public class LocalTypeEvidenceCardPromptLoader implements TypeEvidenceCardPromptLoader {

    private static final String PROMPT_PATH = "secret/evidence-card-prompt-local.txt";
    ...
    public String loadPrompt() {
        try {
            ...
            if (!resource.exists()) {
                log.error("Evidence Card 프롬프트 파일이 존재하지 않습니다: {}", PROMPT_PATH);
            ...
            log.error("로컬 Evidence Card 프롬프트 파일 읽기 실패: {}", PROMPT_PATH, e);
