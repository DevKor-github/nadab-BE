...
public record SocialLoginRequest(
        @Schema(description = "OAuth2 제공자로부터 받은 Authorization Code", example = "MsabWEWdhBgKrZk")
        @NotBlank(message = "Authorization code는 필수입니다")
        String code,

        @Schema(description = "CSRF 방지를 위한 State 파라미터", example = "0328973a-f474f-413a-be5d")
