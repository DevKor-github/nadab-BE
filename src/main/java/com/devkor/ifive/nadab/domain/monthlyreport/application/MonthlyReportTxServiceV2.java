...
@Transactional
public class MonthlyReportTxServiceV2 {

    private final PendingMonthlyReportServiceV2 pendingMonthlyReportServiceV2;
    ...
    public MonthlyReserveResultDto reserveMonthly(User user, boolean exists) {
        ...
        MonthlyReportV2 report = pendingMonthlyReportServiceV2.getOrCreatePendingMonthlyReport(user, exists);
    ...
    public MonthlyReserveResultDto reserveMonthlyAndPublish(User user) {
        ...
        eventPublisher.publishEvent(new MonthlyReportGenerationRequestedEventDtoV2(
                reserve.reportId(),
                user.getId(),
