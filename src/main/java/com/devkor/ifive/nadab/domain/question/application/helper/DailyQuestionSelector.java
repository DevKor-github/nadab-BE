...
public class DailyQuestionSelector {
    ...
    public DailyQuestion pickFirst(Integer interestId, Integer levelOnly) {
    ...
    public DailyQuestion pickReroll(Integer interestId, Long excludeQuestionId, Integer levelOnly) {
